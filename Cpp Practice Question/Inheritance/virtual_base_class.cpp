...
class test : public virtual student //First level derivation
{
    protected:
        float sub1;
        float sub2;
...
int main()
{
    ...
    student1.get_score(50.0);
    student1.display();

    return 0;
}

//The virtual keyword prevents multiple copy of roll_number in result class. data integrity